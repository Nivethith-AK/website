...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background active:scale-95",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--accent-purple)] text-white hover:bg-[color-mix(in srgb, var(--accent-purple), black 20%)] shadow-md shadow-[var(--accent-purple)]/20",
        primary:
          "bg-[var(--accent-purple)] text-white hover:bg-[color-mix(in srgb, var(--accent-purple), black 20%)] shadow-md shadow-[var(--accent-purple)]/20",
        ...
        premium:
          "bg-gradient-to-r from-[var(--accent-purple)] to-[color-mix(in srgb, var(--accent-purple), black 20%)] text-white shadow-xl hover:brightness-110",
      },
      size: {
